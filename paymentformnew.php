<?php
    ...
    echo $_SESSION['name1'];   
        ...
        $sql1112 = "SELECT * FROM PAYMENTDETAILS WHERE STATUS = 'INCOMPLETE' AND APPLICA_NO IN(SELECT APPLIC_NO FROM OWNERS WHERE OWNER_NAME = '$paymentname')";
...
<head>
    ...
    <link rel="stylesheet" href="paymentformnew.css">
</head>
